...
{
    class DownloadSpecifyVillage
    {
        public static async Task<string> Download(string id)
        {
            var Url = new Uri("http://" + StaticVariables.ServerShort + StaticVariables.World + "." + StaticVariables.Server + "/game.php?village=" + id +"&screen=main");
